...
if (VCPKG_CMAKE_SYSTEM_NAME STREQUAL "WindowsStore") # UWP:
    list(APPEND OPTIONS -DCMAKE_DISABLE_FIND_PACKAGE_EGL=ON)
    list(APPEND OPTIONS -DCMAKE_DISABLE_FIND_PACKAGE_PNG=ON)
    list(APPEND OPTIONS -DCMAKE_DISABLE_FIND_PACKAGE_GDAL=ON)
    list(APPEND OPTIONS -DCMAKE_DISABLE_FIND_PACKAGE_GTA=ON)
    list(APPEND OPTIONS -DCMAKE_DISABLE_FIND_PACKAGE_Poppler-glib=ON)
    list(APPEND OPTIONS -DCMAKE_DISABLE_FIND_PACKAGE_GtkGl=ON)
    list(APPEND OPTIONS -DCMAKE_DISABLE_FIND_PACKAGE_RSVG=ON)
    list(APPEND OPTIONS -DOSG_GL_LIBRARY_STATIC=ON)
    list(APPEND OPTIONS -DOPENGL_PROFILE=GLES2)
    list(APPEND OPTIONS -DGL_HEADER_HAS_GLINT64=ON)
    list(APPEND OPTIONS -DGL_HEADER_HAS_GLINT64=OFF)
    list(APPEND OPTIONS -DGL_HEADER_HAS_GLUINT64=OFF)
    list(APPEND OPTIONS -D_OPENTHREADS_ATOMIC_USE_WIN32_INTERLOCKED_EXITCODE=0)
    list(APPEND OPTIONS -D_OPENTHREADS_ATOMIC_USE_WIN32_INTERLOCKED_EXITCODE__TRYRUN_OUTPUT=0)
endif()
